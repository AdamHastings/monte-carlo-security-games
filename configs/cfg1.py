...
params = dict(
    ...
    CAUGHT = np.linspace(0.0, 0.0, 1), # Probability that an attacker is caught and has their assets confiscated
    ...
    MANDATE = np.linspace(0.0, 1.0, 10) # Percentage of assets that are spent on security measures.
)
